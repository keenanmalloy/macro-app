...
// {!isExpanded ? (
// ) : (
//   <div className="flex flex-row justify-between items-center border-y border-slate-300 border-solid pl-3 bg-slate-100">
//     <div className="flex flex-row items-center">
//       <FcPieChart size={40} />
//       <div className="flex flex-col ml-2">
//         <p className="text-sm font-medium truncate">
...
//         </p>
//         <p className="text-xs text-gray-400 flex truncate">
//           {totalProtein}g Pro, {totalFats}g Fat, {totalCarbs}g
//           Carb
//         </p>
//       </div>
//     </div>
//     <div className="text-sm font-medium pl-28 pr-3 py-1 flex flex-col items-end">
//       <p>{totalCalories}</p> <p>kcal</p>
//     </div>
//   </div>
// )}
